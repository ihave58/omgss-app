...
public class ListItemsAdapter extends RecyclerView.Adapter<ListItemsAdapter.ItemsViewholder> {
    ...
    public ListItemsAdapter(ArrayList<Response> products, int position, ProductItemClickListener clickListener) {
        this.mData = products;
    ...
    public void onBindViewHolder(@NonNull ItemsViewholder holder, int position) {
        ...
        if (mData.get(position).getIsAddedToWishlist() == 1) {
            ...
            ivHeart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickListener != null) {
                        ...
                        if (mData.get(getAdapterPosition()).getIsAddedToWishlist() == 0) {
                            mData.get(getAdapterPosition()).setIsAddedToWishlist(1);
                            ivHeart.setImageResource(R.drawable.ic_heart_filled);

                        } else {
                            mData.get(getAdapterPosition()).setIsAddedToWishlist(0);
