...
public class PastOrdersAdapter extends RecyclerView.Adapter<PastOrdersAdapter.ItemsViewholder> {

    private final ArrayList<Response> mOrderList;
    private final RecyclerItemClickListener clickListener;
    private Context mContext;

    public PastOrdersAdapter(ArrayList<Response> ordersList, RecyclerItemClickListener clickListener) {
    ...
    public ItemsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ItemsViewholder(LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_past_orders, parent, false));
    ...
    class ItemsViewholder extends RecyclerView.ViewHolder {
        ...
        @OnClick({R.id.tv_view_details, R.id.tv_reorder})
